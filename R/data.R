...
#'   \item{\code{REGIONC}}{double Census Region}
#'   \item{\code{Region}}{integer Numeric Census Region}
#'   \item{\code{Division}}{integer Census Division}
#'   \item{\code{MSAStatus}}{integer Housing unit in Census Metropolitan Statistical Area or Micropolitan Statistical Area}
#'   \item{\code{Urbanicity}}{integer Census 2010 Urban Type}
#'   \item{\code{HousingUnitType}}{integer Type of housing unit}
#'   \item{\code{YearMade}}{integer Year range when housing unit was built}
#'   \item{\code{SpaceHeatingUsed}}{logical Space heating used}
#'   \item{\code{HeatingBehavior}}{integer Main heating equipment household behavior}
...
#'   \item{\code{ACBehavior}}{integer Central air conditioner household behavior}
...
#'   \item{\code{ClimateRegion_BA}}{integer Building America Climate Zone}
#'   \item{\code{ClimateRegion_IECC}}{integer IECC Climate Code}
